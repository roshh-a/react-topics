...
import { HeaderProps } from "../Helpers/Model"
                ...
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-8">
                            <a href="#" className="text-2xl font-bold text-primary">BR.F</a>
                            <nav className="hidden md:flex items-center gap-6">
                                ...
                                <a href="#" className="hover:text-primary">Brands</a>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {/* Add to cart */}
                            <button type="button" className="relative cursor-pointer" onClick={onCartClick}>
